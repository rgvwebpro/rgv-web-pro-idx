...
if(!function_exists('_rwp_usamls_search_form')) {
	...
	$_rwp_search_form_string = '<!-- RGV Web Pro IDX Plugin <contact@rgvwebpro.com> -->
	<form action="' . get_option($_rwp_usamls_property_URL) . '" target="searchframe_' . get_the_ID() . '" name="usamlsnetform' . get_the_ID() . '" id="" method="POST">
	...
	$_rwp_search_form_string .= '</form>
	<iframe name="searchframe_' . get_the_ID() . '" class="" width="100%" height="1776px" frameborder="0" scrolling="auto" src="' . get_option($_rwp_usamls_property_URL) . '"></iframe>
